...
public class I18nProviderImpl
    ...
    protected synchronized void modified(Map<String, Object> config) {
        ...
        final String measurementSystem = (String) config.get(MEASUREMENT_SYSTEM);
    ...
    private void setTimeZone(final ZoneId timeZone) {
        if (timeZone != null) {
            try {
                ...
                logger.warn("Could not set a new time zone, the system's default time zone will be used ", timeZone,
                        e.getMessage());
            }
        }
    }
